  ...
  return (
    <div className={styles.Why_choose_us}>
     ...
     <div className={styles.choose1}>
        ...
        <Image src={'/images/online-learning.png'} alt=' ' width={50} height={50}/>
        </div>
        <h3>
     ...
     <div  className={styles.choose1}>
        <div className={styles.choose_icon_1}>
        <Image src={'/images/biometric.png'} alt=' ' width={50} height={50}/>
        </div>
        <h3>
     ...
     <div  className={styles.choose1}>
        <div className={styles.choose_icon_1}>
        <Image src={'/images/search.png'} alt=' ' width={50} height={50}/>
        </div>
        <h3>
